...
import evelynWithDogs from '../../assets/brand/evelyn-com-cachorros-seo.jpg';
      ...
      <S.Inner>
        ...
        <S.Content>
          <S.Visual as={motion.figure} {...state} variants={revealSoft}>
            <img src={evelynWithDogs} alt="Evelyn Peneluppi com seus dois cachorros em frente a uma igreja" width="1050" height="1400" loading="lazy" decoding="async" />
