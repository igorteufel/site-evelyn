...
import evelynPortrait from '../../assets/brand/evelyn-editorial.jpg';
    ...
    <S.Section aria-label="Mensagem sobre iniciar terapia">
      <S.Inner>
        ...
        <S.Portrait as={motion.div} {...state} variants={reveal}>
          <img src={evelynPortrait} alt="Evelyn Peneluppi sentada à mesa com uma caneta na mão" width="1000" height="1500" loading="lazy" decoding="async" />
