...
const questions = [
  ...
  { question: 'Como funciona a terapia online?', answer: 'As sessões acontecem por videochamada, pelo Google Meet, em um horário combinado. Como o atendimento é exclusivamente online, você não precisa morar em Jacareí. É importante estar em um ambiente reservado, com conexão estável e privacidade para falar com tranquilidade.' },
  { question: 'A psicoterapia online é indicada para adolescentes?', answer: 'O atendimento online pode ser uma possibilidade para adolescentes, considerando a idade, as necessidades de cada caso e as condições de privacidade. Esses pontos são conversados no primeiro contato.' },
